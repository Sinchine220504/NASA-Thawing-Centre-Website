...
export const metadata = { title: 'Fitment Services — NASA Thawing Centre', description: 'Certified accessory fitment.' };

export default function FitmentServicesPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold">Fitment Services</h1>
        <p className="text-gray-700 mt-3 max-w-2xl">Upgrade your vehicle with certified installation services.</p>
        <ul className="mt-6 list-disc list-inside space-y-2 text-gray-800">
          <li>Accessories fitment</li>
          <li>OEM-grade wiring</li>
