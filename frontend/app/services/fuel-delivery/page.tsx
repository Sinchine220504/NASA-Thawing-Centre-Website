...
export const metadata = { title: 'Fuel Delivery — NASA Thawing Centre', description: 'Emergency fuel delivered on the spot.' };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold">Fuel Delivery</h1>
        <p className="text-gray-700 mt-3 max-w-2xl">Emergency petrol/diesel delivered on the spot.</p>
        <ul className="mt-6 list-disc list-inside space-y-2 text-gray-800">
          <li>Measured delivery</li>
          <li>Safety-first protocol</li>
          <li>Nearby coverage</li>
        </ul>
        <div className="mt-8">
